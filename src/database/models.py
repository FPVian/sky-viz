...
class FlightAggregates(Base):
    ...
    avg_ground_speed_knots: Mapped[float]
    min_ground_speed_knots: Mapped[float]
    max_ground_speed_knots: Mapped[float]
    ...
    avg_altitude_ft: Mapped[float]
    max_altitude_ft: Mapped[int]
    ...
    max_climb_rate_ft_per_min: Mapped[int]
    ...
    max_descent_rate_ft_per_min: Mapped[int]
