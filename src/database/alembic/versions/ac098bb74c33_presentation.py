...
Revision ID: ac098bb74c33
Revises: fcd06ea9f570
Create Date: 2023-11-05 20:36:10.792342
...
def upgrade() -> None:
    ...
    op.create_table('daily_flight_totals',
    ...
    op.create_table('monthly_flight_totals',
    ...
    op.create_table('weekly_flight_totals',
...
def downgrade() -> None:
    ...
    op.drop_table('weekly_flight_totals')
