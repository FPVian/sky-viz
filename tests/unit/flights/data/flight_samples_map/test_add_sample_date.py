...
def test_add_sample_date_adds_timestamp():
    '''
    Test that the add_sample_date method adds the current time to each row of the flight sample.
    ...
    transformed_sample = FlightSamplesMapper()._add_sample_date(flight_sample)
